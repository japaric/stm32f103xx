...
pub type OC4MR = ::tim1::ccmr1_output::OC1MR;
#[doc = r" Value of the field"]
pub struct OC4PER {
    bits: bool,
}
...
pub type OC3MR = ::tim1::ccmr1_output::OC1MR;
#[doc = r" Value of the field"]
pub struct OC3PER {
    bits: bool,
}
...
pub type OC4MW = ::tim1::ccmr1_output::OC1MW;
#[doc = r" Proxy"]
pub struct _OC4MW<'a> {
    w: &'a mut W,
}
...
pub type OC3MW = ::tim1::ccmr1_output::OC1MW;
#[doc = r" Proxy"]
pub struct _OC3MW<'a> {
    w: &'a mut W,
}
